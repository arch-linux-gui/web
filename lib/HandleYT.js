...
const HandleYT = ({ videoId }) => {
  ...
  return (
    <div>
      {loading ? (
        <div className="flex items-center justify-center border w-full h-[300px] md:h-[500px] rounded-2xl bg-opacity-0">
        ...
        <iframe
          ...
          allowFullScreen
          title="Video Player"
          className="w-full h-[300px] md:h-[500px] rounded-2xl border"
